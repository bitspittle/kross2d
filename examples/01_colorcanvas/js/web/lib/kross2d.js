...
var kross2d = function (_, Kotlin) {
  ...
  function Application(params, initialState) {
    ...
    var updateContext = new Application_init$ObjectLiteral_0(appFacade, this, keyboard, timer);
    var drawContext = new Application_init$ObjectLiteral_1(this, timer);
  ...
  function Application_init$ObjectLiteral_0(closure$appFacade, this$Application, closure$keyboard, closure$timer) {
  ...
  Object.defineProperty(Application_init$ObjectLiteral_0.prototype, 'app', {
    get: function () {
  ...
  Object.defineProperty(Application_init$ObjectLiteral_0.prototype, 'keyboard', {
    get: function () {
  ...
  function Application_init$ObjectLiteral_1(this$Application, closure$timer) {
    this.screen_4j6xmw$_0 = this$Application.backend_0.drawSurface;
    this.timer_rwuagb$_0 = closure$timer;
  }
  ...
  function AppParams(canvasElement) {
  ...
  ApplicationBackend$drawSurface$ObjectLiteral.prototype.clear_msppnp$ = function (color) {
    this.this$ApplicationBackend.gl_0.clearColor(color.r / 255.0, color.g / 255.0, color.b / 255.0, color.a / 255.0);
    this.this$ApplicationBackend.gl_0.clear(WebGLRenderingContext.COLOR_BUFFER_BIT);
  };
